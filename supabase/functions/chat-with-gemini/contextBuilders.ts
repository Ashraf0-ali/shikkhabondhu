...
- বই চাইলে প্রথমে বলুন "হ্যাঁ, আমার কাছে আছে" তারপর PDF লিংক দিন
...
export const buildBookContext = (books: any[], message: string) => {
  ...
  context += `\n\n🎯 বই চাইলে অবশ্যই "হ্যাঁ, আমার কাছে আছে" বলে PDF লিংক দিন।`;
...
2. বই চাইলে:
   - প্রথমে বলুন "হ্যাঁ, আমার কাছে আছে।"
   - তারপর PDF লিংক দিন: "🔗 PDF লিংক: [URL]"
...
- উপরের MCQ তালিকা থেকে প্রাসঙ্গিক প্রশ্ন বেছে নিন`;
  ...
  const bookKeywords = ['বই', 'পিডিএফ', 'pdf', 'শ্রেণী', 'class'];
...
- অবশ্যই "হ্যাঁ, আমার কাছে আছে।" বলুন
- উপরের বইয়ের তালিকা থেকে PDF লিংক দিন`;
  }
