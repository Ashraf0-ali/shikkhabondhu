...
export const buildMCQContext = (mcqData: any[]) => {
  ...
  // Show a few sample MCQs
  mcqData.slice(0, 5).forEach((mcq, index) => {
...
2. বই চাইলে অবশ্যই প্রথমে বলুন "হ্যাঁ, আমার কাছে আছে।" তারপর সাথে সাথে PDF লিংক দিন
3. PDF লিংক ফরম্যাট: "🔗 PDF লিংক: [URL]" - এই ফরম্যাট অবশ্যই ব্যবহার করুন
4. বই/MCQ না থাকলে বলুন "দুঃখিত, আমার কাছে এটি নেই"
5. MCQ চাইলে অপশন সহ দিন এবং সঠিক উত্তর দিন
6. পূর্বের কথোপকথনের ভিত্তিতে উত্তর দিন
7. কখনো শুধু "হ্যাঁ আমার কাছে আছে" বলে থেমে যাবেন না - অবশ্যই MCQ/PDF লিংক দিন
